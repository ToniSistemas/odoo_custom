...
# todos los scripts y estilos servidos desde /vinedo_cuaderno_campo/static/src/
...
_VIEWER_HTML = (
    ...
    '<link rel="stylesheet"'
    '  href="/vinedo_cuaderno_campo/static/src/lib/leaflet/leaflet.css?v=2.2.0"/>'
    '<link rel="stylesheet"'
    '  href="/vinedo_cuaderno_campo/static/src/sigpac_viewer.css?v=2.2.0"/>'
    '</head>'
    '<body>'
    '<div id="descripcion">'
    ...
    '<script src="/vinedo_cuaderno_campo/static/src/lib/leaflet/leaflet.js?v=2.2.0"></script>'
    '<script src="/vinedo_cuaderno_campo/static/src/sigpac_viewer.js?v=2.2.0"></script>'
    '</body>'
    '</html>'
)

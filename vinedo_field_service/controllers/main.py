...
_VIEWER_HTML = (
    ...
    '<link rel="stylesheet"'
    '  href="/vinedo_field_service/static/src/lib/leaflet/leaflet.css?v=1.8.7"/>'
    '<link rel="stylesheet"'
    '  href="/vinedo_field_service/static/src/sigpac_viewer.css?v=1.8.7"/>'
    '</head>'
    '<body>'
    '<div id="map">'
    '  <div id="zoom-hint">'
    ...
    '<script src="/vinedo_field_service/static/src/lib/leaflet/leaflet.js?v=1.8.7"></script>'
    '<script src="/vinedo_field_service/static/src/sigpac_viewer.js?v=1.8.7"></script>'
    '</body>'
    '</html>'
)
